...
'--stats_dir', type=str, default="./data/stats", help='the path of stat file'

'--model', type=str, choices=["EleutherAI/gpt-j-6B","gpt2-xl"], default="gpt2-xl", help='the model to use'

"--ds_dir", type=str, choices=["./editing-data/data/zsre/zsre_mend_eval.json", "./editing-data/data/counterfact/counterfact-edit.json"], default="./editing-data/data/zsre/zsre_mend_eval.json", help="the dataset directory"

'--consecutive', type=bool, default=False, help='whether the editing happens in a consecutive way'

'--bsz', type=int, default=30, help='the editing batch size to use'

'--mom2_update_weight', type=int, default=15000, help='the moment2 update weight'

'--alpha_z', type=float, default=2.2, help='the initial alpha'

'--num_layers', type=int, choices=range(1,8), default=8, help='the number of layers in the critical path to use'

'--sample', type=int, default=100, help='number of samples to use'

'--wohk', type=bool, default=False, help='whether to use the hook layer'
